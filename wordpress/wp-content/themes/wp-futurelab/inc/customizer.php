...
function wp_futurelab_custom_header_and_background() {
	$color_scheme             = wp_futurelab_get_color_scheme();
	 ...
	 * }
	 */
	add_theme_support( 'custom-background', apply_filters( 'wp_futurelab_custom_background_args', array(
 ...
 */
function wp_futurelab_customize_register( $wp_customize ) {
	$color_scheme = wp_futurelab_get_color_scheme();
	...
	$wp_customize->add_setting( 'color_scheme', array(
		'default'           => 'default',
		'sanitize_callback' => 'wp_futurelab_sanitize_color_scheme',
		'transport'         => 'postMessage',
	) );

	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'wp_futurelab' ),
		'section'  => 'colors',
		'type'     => 'select',
		'choices'  => wp_futurelab_get_color_scheme_choices(),
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'page_background_color', array(
		'label'       => __( 'Page Background Color', 'wp_futurelab' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color', array(
		'label'       => __( 'Link Color', 'wp_futurelab' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'main_text_color', array(
		'label'       => __( 'Main Text Color', 'wp_futurelab' ),
		'section'     => 'colors',
	) ) );
...
function wp_futurelab_get_color_schemes() {
	 ...
	 * }
	 */
	return apply_filters( 'wp_futurelab_color_schemes', array(
		'default' => array(
			'label'  => __( 'Default', 'wp_futurelab' ),
			'colors' => array(
				'#1a1a1a',
				'#ffffff',
				'#007acc',
 ...
 */
function wp_futurelab_color_scheme_css() {
	$color_scheme_option = get_theme_mod( 'color_scheme', 'default' );
	...
	$color_textcolor_rgb = wp_futurelab_hex2rgb( $color_scheme[3] );
	...
	$color_scheme_css = wp_futurelab_get_color_scheme_css( $colors );

	wp_add_inline_style( 'wp_futurelab-style', $color_scheme_css );
}
add_action( 'wp_enqueue_scripts', 'wp_futurelab_color_scheme_css' );
...
function wp_futurelab_customize_control_js() {
	...
	wp_localize_script( 'color-scheme-control', 'colorScheme', wp_futurelab_get_color_schemes() );
}
add_action( 'customize_controls_enqueue_scripts', 'wp_futurelab_customize_control_js' );
...
add_action( 'customize_preview_init', 'wp_futurelab_customize_preview_js' );
 ...
 */
function wp_futurelab_get_color_scheme_css( $colors ) {
...
function wp_futurelab_color_scheme_css_template() {
	...
	?>
	<script type="text/html" id="tmpl-wp_futurelab-color-scheme">
		<?php echo wp_futurelab_get_color_scheme_css( $colors ); ?>
	</script>
	<?php
}
add_action( 'customize_controls_print_footer_scripts', 'wp_futurelab_color_scheme_css_template' );
 ...
 * @see wp_add_inline_style()
 */
function wp_futurelab_page_background_color_css() {
	$color_scheme          = wp_futurelab_get_color_scheme();
	...
	wp_add_inline_style( 'wp_futurelab-style', sprintf( $css, $page_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'wp_futurelab_page_background_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function wp_futurelab_link_color_css() {
	$color_scheme    = wp_futurelab_get_color_scheme();
	...
	wp_add_inline_style( 'wp_futurelab-style', sprintf( $css, $link_color ) );
}
add_action( 'wp_enqueue_scripts', 'wp_futurelab_link_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function wp_futurelab_main_text_color_css() {
	$color_scheme    = wp_futurelab_get_color_scheme();
	...
	// Convert main text hex color to rgba.
	$main_text_color_rgb = wp_futurelab_hex2rgb( $main_text_color );
	...
	wp_add_inline_style( 'wp_futurelab-style', sprintf( $css, $main_text_color, $border_color ) );
}
add_action( 'wp_enqueue_scripts', 'wp_futurelab_main_text_color_css', 11 );
 ...
 * @see wp_add_inline_style()
 */
function wp_futurelab_secondary_text_color_css() {
	$color_scheme    = wp_futurelab_get_color_scheme();
	...
	wp_add_inline_style( 'wp_futurelab-style', sprintf( $css, $secondary_text_color ) );
}
add_action( 'wp_enqueue_scripts', 'wp_futurelab_secondary_text_color_css', 11 );
