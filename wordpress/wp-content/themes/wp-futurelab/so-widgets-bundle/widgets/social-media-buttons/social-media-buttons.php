...
class SiteOrigin_Widget_SocialMediaButtons_Widget extends SiteOrigin_Widget {
	...
	function enqueue_admin_scripts() {
		wp_enqueue_script( 'sow-social-media-buttons', SOW_BUNDLE_URI . 'widgets/social-media-button/js/social-media-buttons-admin.js', array( 'jquery' ), SOW_BUNDLE_VERSION );
	}
