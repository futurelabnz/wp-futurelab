<div class="wrap" id="sow-widgets-page">
	<div class="page-banner">
		...
		<span class="icon">
			<img src="<?php echo SOW_BUNDLE_URI ?>admin/images/icon-back.png" class="icon-back" width="50" height="43">
			<img src="<?php echo SOW_BUNDLE_URI ?>admin/images/icon-gear.png" class="icon-gear" width="26" height="26">
			<img src="<?php echo SOW_BUNDLE_URI ?>admin/images/icon-front.png" class="icon-front" width="50" height="43">
		</span>
		...
		<?php foreach( $widgets as $file => $widget ): ?>
			<div class="so-widget-wrap">
				<div class="so-widget so-widget-is-<?php echo $widget['Active'] ? 'active' : 'inactive' ?>" data-id="<?php echo esc_attr( $widget['ID'] ) ?>">
					...
					<?php
					$banner = '';
					if( file_exists( SOW_BUNDLE_URI . 'widgets/'. $widget['File'] . '/assets/banner.svg' ) ) {
						$banner = SOW_BUNDLE_URI . 'widgets/'. $widget['File'] . '/assets/banner.svg';
					}
