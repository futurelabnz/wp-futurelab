...
define('SOW_BUNDLE_VERSION', '1.5.6');
...
$so_widgets_bundle_uri = get_template_directory_uri()."/so-widgets-bundle/";
define('SOW_BUNDLE_URI', $so_widgets_bundle_uri);
...
class SiteOrigin_Widgets_Bundle {
	...
	function admin_enqueue_scripts($prefix) {
		...
		wp_enqueue_style( 'siteorigin-widgets-manage-admin', SOW_BUNDLE_URI . 'admin/admin.css', array(), SOW_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-trianglify', SOW_BUNDLE_URI . 'admin/trianglify' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-manage-admin', SOW_BUNDLE_URI . 'admin/admin' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_BUNDLE_VERSION );
