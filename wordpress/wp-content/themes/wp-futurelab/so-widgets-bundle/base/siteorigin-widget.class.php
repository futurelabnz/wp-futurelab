...
abstract class SiteOrigin_Widget extends WP_Widget {
	...
	function enqueue_scripts(){
		...
		if( !wp_script_is('siteorigin-widget-admin') ) {
			...
			wp_enqueue_style( 'siteorigin-widget-admin', SOW_BUNDLE_URI.'base/css/admin.css', array( 'media-views' ), SOW_BUNDLE_VERSION );


			wp_enqueue_script( 'wp-color-picker' );
			wp_enqueue_media();
			wp_enqueue_script( 'siteorigin-widget-admin', SOW_BUNDLE_URI.'base/js/admin' . SOW_BUNDLE_JS_SUFFIX . '.js', array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-slider' ), SOW_BUNDLE_VERSION, true );
