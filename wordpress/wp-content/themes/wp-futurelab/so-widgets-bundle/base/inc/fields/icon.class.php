...
class SiteOrigin_Widget_Field_Icon extends SiteOrigin_Widget_Field_Base {
	...
	public function enqueue_scripts(){
		wp_enqueue_script( 'so-icon-field', SOW_BUNDLE_URI . 'js/icon-field' . SOW_BUNDLE_JS_SUFFIX .  '.js', array( 'jquery' ), SOW_BUNDLE_VERSION );
		wp_enqueue_style( 'so-icon-field', SOW_BUNDLE_URI . 'css/icon-field.css', array( ), SOW_BUNDLE_VERSION );
	}
