...
class SiteOrigin_Panels_Widgets_EmbeddedVideo extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if(!wp_script_is('fitvids'))
			wp_enqueue_script('fitvids', SITEORIGIN_PANELS_URI.'widgets/js/jquery.fitvids.js', array('jquery'), SITEORIGIN_PANELS_VERSION);

		if(!wp_script_is('siteorigin-panels-embedded-video'))
			wp_enqueue_script('siteorigin-panels-embedded-video', SITEORIGIN_PANELS_URI.'widgets/js/embedded-video.js', array('jquery', 'fitvids'), SITEORIGIN_PANELS_VERSION);
