...
class SiteOrigin_Panels_Settings {
	...
	function admin_scripts($prefix){
		...
		wp_enqueue_style( 'siteorigin-panels-settings', SITEORIGIN_PANELS_URI . 'settings/admin-settings.css', array(), SITEORIGIN_PANELS_VERSION );
		wp_enqueue_script( 'siteorigin-panels-settings', SITEORIGIN_PANELS_URI . 'settings/admin-settings' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array(), SITEORIGIN_PANELS_VERSION );
	}
