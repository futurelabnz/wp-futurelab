<div class="wrap" id="panels-settings-page">
	<div class="settings-banner">
		...
		<span class="icon">
			<img src="<?php echo SITEORIGIN_PANELS_URI ?>../images/icon-layer.png" class="layer-3" />
			<img src="<?php echo SITEORIGIN_PANELS_URI ?>../images/icon-layer.png" class="layer-2" />
			<img src="<?php echo SITEORIGIN_PANELS_URI ?>../images/icon-layer.png" class="layer-1" />
		</span>
