...
$siteorigin_panels_uri = get_template_directory_uri()."/siteorigin-panels/";

define('SITEORIGIN_PANELS_URI', $siteorigin_panels_uri);
...
function siteorigin_panels_admin_enqueue_scripts( $prefix = '', $force = false ) {
	...
	if ( $force || siteorigin_panels_is_admin_page() ) {
		...
		wp_enqueue_script( 'so-panels-admin', SITEORIGIN_PANELS_URI . 'js/siteorigin-panels' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'jquery', 'jquery-ui-resizable', 'jquery-ui-sortable', 'jquery-ui-draggable', 'underscore', 'backbone', 'plupload', 'plupload-all' ), SITEORIGIN_PANELS_VERSION, true );
		wp_enqueue_script( 'so-panels-admin-utils', SITEORIGIN_PANELS_URI . 'js/siteorigin-panels-utils' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'jquery', 'underscore', 'backbone', 'wp-color-picker' ), SITEORIGIN_PANELS_VERSION, true );
		wp_enqueue_script( 'so-panels-admin-styles', SITEORIGIN_PANELS_URI . 'js/siteorigin-panels-styles' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'jquery', 'underscore', 'backbone', 'wp-color-picker' ), SITEORIGIN_PANELS_VERSION, true );

		if( $screen->base != 'widgets' && $screen->base != 'customize' ) {
			// We don't use the history browser and live editor in the widgets interface
			wp_enqueue_script( 'so-panels-admin-history', SITEORIGIN_PANELS_URI . 'js/siteorigin-panels-history' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'so-panels-admin', 'jquery', 'underscore', 'backbone' ), SITEORIGIN_PANELS_VERSION, true );
			wp_enqueue_script( 'so-panels-admin-live-editor', SITEORIGIN_PANELS_URI . 'js/siteorigin-panels-live-editor' . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'so-panels-admin', 'jquery', 'underscore', 'backbone' ), SITEORIGIN_PANELS_VERSION, true );
		}
...
function siteorigin_panels_admin_enqueue_styles( $prefix = '', $force = false ) {
	if ( $force || siteorigin_panels_is_admin_page() ) {
		wp_enqueue_style( 'so-panels-admin', SITEORIGIN_PANELS_URI . 'css/admin.css', array( 'wp-color-picker' ), SITEORIGIN_PANELS_VERSION );
...
function siteorigin_panels_enqueue_styles(){
	...
	wp_register_style('siteorigin-panels-front', SITEORIGIN_PANELS_URI . 'css/front.css', array(), SITEORIGIN_PANELS_VERSION );
