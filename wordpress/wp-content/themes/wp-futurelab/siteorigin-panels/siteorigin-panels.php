...
function siteorigin_panels_admin_enqueue_scripts( $prefix = '', $force = false ) {
	...
	if ( $force || siteorigin_panels_is_admin_page() ) {
		...
		wp_enqueue_media();
		wp_enqueue_script( 'so-panels-admin', SITEORIGIN_PANELS_URI . 'js/siteorigin-panels' . SITEORIGIN_PANELS_VERSION_SUFFIX . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'jquery', 'jquery-ui-resizable', 'jquery-ui-sortable', 'jquery-ui-draggable', 'underscore', 'backbone', 'plupload', 'plupload-all' ), SITEORIGIN_PANELS_VERSION, true );
